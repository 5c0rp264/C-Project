...
namespace EasySave_graphical
{
    public partial class graphical_interface : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                // add the backup
                MessageBox.Show(add_name.Text + "\n" + add_sourceFolder + "\n" + add_destinationFolder + "\n" + backupType + "\n" + add_extension.Text);
            }
            else
            {
        ...
        private void edit_label_Click(object sender, EventArgs e)
        {
            ...
            {
                // Edit the backup
                MessageBox.Show(edit_name.Text + "\n" + edit_sourceFolderValue + "\n" + edit_destinationFolderValue + "\n" + edit_backupType + "\n" + edit_extension.Text);
            }
            else
            {
        ...
        private void delete_validation_Click(object sender, EventArgs e)
        {
                if (delete_backup_list.SelectedItems.Count == 1)
                {
                    ...
                    MessageBox.Show("Deleting : " + delete_backup_list.SelectedItem);
                     }
                }
                else
                {
        ...
        private void execute_play_Click(object sender, EventArgs e)
        {
            ...
            {
                foreach (string selectedBackup in execute_backup_list.SelectedItems)
                {
                    // Call the model to execute the backup
                    MessageBox.Show(selectedBackup);
                }
            }
            else
            {
